...
Title::Title(QWidget *parent)
    ...
    connect(ui->CloseBtn, &QPushButton::clicked,
            this, &Title::sigCloseBtnClicked);
    connect(ui->MinBtn, &QPushButton::clicked,
            this, &Title::sigMinBtnClicked);
    connect(ui->MaxBtn, &QPushButton::clicked,
            this, &Title::sigMaxBtnClicked);
    connect(ui->FullScreenBtn, &QPushButton::clicked,
            this, &Title::sigFullScreenBtnClicked);
    connect(ui->MenuBtn, &QPushButton::clicked,
            this, &Title::sigShowMenu);
